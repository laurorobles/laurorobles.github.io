...
start_marker = "const sigilInput = document.getElementById('sigil-input');"
end_marker = "/* =========================================================\n       10. PLUGINS & DSP\n       ========================================================= */"

if start_marker in js and end_marker in js:
    pre = js.split(start_marker)[0]
    post = js.split(end_marker)[1]
    
    new_logic = """const sigilInput = document.getElementById('sigil-input');
